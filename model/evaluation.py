...
def evaluate(model_spec, model_dir, params, restore_from, eval_placeholder, eval_lb_placeholder):
    """Evaluate the model
    ...
    with tf.Session() as sess:
        ...
        metrics = evaluate_sess(sess, model_spec, num_steps, eval_placeholder, eval_lb_placeholder)
